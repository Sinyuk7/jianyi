...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = getDrawable(getContext(), R.drawable.ic_keyboard_arrow_down_grey600_24dp);
        }
        if (mCollapseDrawable == null) {
            mCollapseDrawable = getDrawable(getContext(), R.drawable.ic_keyboard_arrow_up_grey600_24dp);
        }
