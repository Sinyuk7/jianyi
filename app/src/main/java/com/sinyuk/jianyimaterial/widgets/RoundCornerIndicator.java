...
public class RoundCornerIndicator extends View implements PageIndicator {
    ...
    public RoundCornerIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        indicatorWidth = ta.getDimensionPixelSize(R.styleable.RoundCornerIndicator_my_width, dp2px(8));
        indicatorHeight = ta.getDimensionPixelSize(R.styleable.RoundCornerIndicator_my_height, dp2px(8));
        indicatorGap = ta.getDimensionPixelSize(R.styleable.RoundCornerIndicator_my_gap, dp2px(8));
        cornerRadius = ta.getDimensionPixelSize(R.styleable.RoundCornerIndicator_my_cornerRadius, dp2px(4));
        strokeWidth = ta.getDimensionPixelSize(R.styleable.RoundCornerIndicator_my_strokeWidth, dp2px(0));
        selectColor = ta.getColor(R.styleable.RoundCornerIndicator_my_selectColor, Color.parseColor("#ffffff"));
        unselectColor = ta.getColor(R.styleable.RoundCornerIndicator_my_unselectColor, Color.parseColor("#25c4ec"));
        strokeColor = ta.getColor(R.styleable.RoundCornerIndicator_my_strokeColor, Color.parseColor("#ffffff"));
        isSnap = ta.getBoolean(R.styleable.RoundCornerIndicator_my_isSnap, false);
