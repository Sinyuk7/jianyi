 ...
 */
public class ArrowUpPagerIndicator extends LinearLayout {
    ...
    private static final int COLOR_TEXT_NORMAL = 0xdcffffff;
    private static final int COLOR_TEXT_HIGHLIGHT = 0xFFFFFFFF;

    private List<String> mTitles;

    public ArrowUpPagerIndicator(Context context) {
        this(context, null);
    }

    public ArrowUpPagerIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);

        // 获取可见Tab的数量
        TypedArray a = context.obtainStyledAttributes(attrs,
                R.styleable.ArrowUpPagerIndicator);

        mTabVisibleCount = a.getInt(
                R.styleable.ArrowUpPagerIndicator_visible_tab_count,
                COUNT_DEFAULT_TAB);
        ...
        mPaint.setColor(getResources().getColor(R.color.window_background));
