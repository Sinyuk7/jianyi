package com.sinyuk.jianyimaterial.widgets.likebutton;
...
public class LikeButton extends FrameLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (iconType != null) {
            if (!iconType.isEmpty()) { currentIcon = parseIconType(iconType); }
        }
    ...
    public void onClick(View v) {
        ...
        if (isChecked) {
            ...
            animatorSet.addListener(new AnimatorLayerListener(this) {
                @Override
