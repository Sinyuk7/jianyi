 ...
 */
public abstract class ExtendedRecyclerViewAdapter<T, VH extends RecyclerView.ViewHolder> extends BaseRecyclerViewAdapter<T> {
    public ExtendedRecyclerViewAdapter(Context context) {
        super(context);
    }
    ...
    @Override
    public void notifyMyItemListChanged(List<T> list) {
        super.notifyMyItemListChanged(list);
    }
