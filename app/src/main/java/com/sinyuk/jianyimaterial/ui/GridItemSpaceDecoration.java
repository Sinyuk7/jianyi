...
public class GridItemSpaceDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridItemSpaceDecoration(int spanCount, int resId, boolean includeEdge, Context context) {
        this.mSpace = context.getResources().getDimensionPixelOffset(resId);
        this.spanCount = spanCount;
        this.includeEdge = includeEdge;
    }

    public GridItemSpaceDecoration(int spanCount, int mSpace, boolean includeEdge) {
        this.spanCount = spanCount;
        this.mSpace = mSpace;
        this.includeEdge = includeEdge;
    }
